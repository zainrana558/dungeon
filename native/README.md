...
- production content registry with character animation bibles, movement identities, enemy memory rules, 25 authored floor beats, and audio patch metadata;
- complete monster/boss action database with 146 Google-Sheets-ready action records and C++ lookup/export helpers;
- character action database with six 30-action sheets, base prompt palettes, and TSV export for batch sprite generation.
